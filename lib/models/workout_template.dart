...
class WorkoutTemplate extends HiveObject{
  ...
  @HiveField(1)
  String name; // The name the user gives to their template (e.g., "Push Day", "Full Body Workout")
  ...
  @HiveField(4)
  DateTime? lastWorkoutDate; // An optional field to store the last time this template was used to start a workout.
